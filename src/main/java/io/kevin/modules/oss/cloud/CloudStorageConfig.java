...
import io.kevin.common.validator.group.AliyunGroup;
import io.kevin.common.validator.group.QcloudGroup;
import io.kevin.common.validator.group.QiniuGroup;
...
public class CloudStorageConfig implements Serializable {
    ...
    //七牛绑定的域名
    @NotBlank(message = "七牛云绑定的域名不能为空", groups = QiniuGroup.class)
    @URL(message = "七牛云绑定的域名格式不正确", groups = QiniuGroup.class)
    ...
    @NotBlank(message = "七牛云SecretKey不能为空", groups = QiniuGroup.class)
